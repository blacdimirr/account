...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $arrPermissions = [
            ...
            [
                'name' => 'manage ncf type',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'create ncf type',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            ...
            [
                'name' => 'delete ncf type',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'manage ncf sequence',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'create ncf sequence',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'edit ncf sequence',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'delete ncf sequence',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
